    ...
    if LOG_FILE is not None:
        ...
        try:
            ...
            log_fid.write(
                ...
                "power,ang_mom,avg_accel,dispersion\n"
            )
    ...
    while running:
        ...
        if not paused:
            ...
            ext_info_line = (
                ...
                f"P={metrics.power:.1f}  L={metrics.angular_momentum:.0f}  |a|={metrics.avg_acceleration:.3f}  σ={metrics.dispersion:.0f}"
            )
            ...
            if log_fid is not None and frame % LOG_EVERY == 0:
                ...
                log_fid.write(
                    ...
                    f"{metrics.avg_acceleration:.4f},{metrics.dispersion:.4f}\n"
                )
                log_fid.flush()
